...
export default function Login({store})
{
    ...
    return(
        <div id="idlogin" className="login-form" onMouseOver={handleMouseOver} onMouseLeave={handleMouseLeave} style={{ border: "1px solid red", width: "250px", height: "350px", borderRadius: "25px", backgroundColor: "aliceblue", padding: "100px", marginTop: "90px" }}>
